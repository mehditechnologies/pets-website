export default function Footer() {
  return (
    <footer className="bg-[#FFF4EA] text-[#9494A5] py-16 mt-40">
      {/* Main Footer */}
      <div className="max-w-7xl mx-5 md:mx-16 lg:mx-28 py-11 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4">
            {["fb", "x", "lin", "insta"].map((icon, i) => (
              <div key={i} className="w-10 h-10 flex items-center justify-center rounded-full bg-white shadow cursor-pointer">
        ...
        {/* Useful Links */}
        <div className="flex-1 md:ml-20 lg:ml-56">
          <p className="font-[Peralta] text-black text-base sm:text-lg mb-3">Useful Links</p>
        ...
        {/* Explore */}
        <div className="flex-1">
          <p className="font-[Peralta] text-black text-base sm:text-lg mb-3">Explore</p>
          <ul className="font-[Poppins] flex flex-col gap-3 text-sm pt-5">
        ...
        {/* Contact Info */}
        <div className="flex-1">
          <p className="font-[Peralta] text-black text-base sm:text-lg mb-3">Contact Info</p>
          <ul className="font-[Poppins] flex flex-col gap-3 text-sm pt-5">
      ...
      {/* Divider + Copyright */}
      <div className="font-[Poppins] border-t-2 border-[#FFB800] py-4 text-sm mx-5 md:mx-16 lg:mx-28 text-center">
