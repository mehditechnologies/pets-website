  ...
  return (
    <>
      <section className="relative flex flex-wrap justify-center text-center gap-9 my-44">
        ...
        <p className="font-[Poppins] text-[#656689] font-normal text-[22px] px-[450px]">
        ...
        <div className="flex gap-20">
          <div className="flex flex-col gap-5 my-28">
            {cartItems.map((product, index) => (
              <div
                key={index}
                className="flex flex-wrap pt-7 shadow rounded-lg justify-between items-start w-[754px] h-[257px] px-4"
              >
                <img
                  src={product.image}
                  alt={product.name}
                  className="w-[177px] h-[192px] object-contain mb-4"
                />
                <div className="flex-1 flex flex-col pl-12">
                  <h3 className="font-[Rubik] text-[28px] font-normal text-start text-[#222] w-[300px]">
                    {product.name}
                  </h3>
                  <p className="font-[Rubik] font-normal text-[22px] text-[#979697] text-start mt-2 w-[300px]">
                    {product.description}
                  </p>
                  <div className="flex justify-between">
                    <p className="font-[Rubik] font-normal text-[22px] text-start">
                      300 EGP &nbsp;&nbsp;
