  ...
  return (
    <div className="flex items-center justify-between p-5 bg-white mt-2.5 mx-5">
      ...
      <div className="flex gap-4">
        <button className="px-4 py-2 bg-[#FFD56E] text-white rounded-lg hover:bg-amber-400 transition">
          Sign in
        </button>

        <button className="px-4 py-2 border border-[#FFD56E] text-[#FFD56E] rounded-lg hover:bg-[#FFD56E] hover:text-white transition">
          Register
        </button>
