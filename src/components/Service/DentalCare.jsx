      ...
      <section>
        <div className="relative flex flex-col justify-center text-start gap-10 px-4 sm:mx-14 my-28">
          ...
          <div className="flex flex-col font-[Poppins] gap-10 text-left w-full max-w-[1150px]">
            <p className="font-normal text-[16px] sm:text-[25px] leading-relaxed">
              Dental health is a very important part of your pet’s overall health, and dental problems can cause, or be caused by, other health problems.<br />
            ...
            <h2 className="font-semibold text-[20px] sm:text-[30px]">Causes of pet dental problems</h2>
            ...
            <h2 className="font-semibold text-[20px] sm:text-[30px]">Why does dentistry require anesthesia?</h2>

            <p className="font-normal text-[16px] sm:text-[25px] leading-relaxed">
              When you go to the dentist, you know that what’s being done is meant to help you and keep your mouth healthy. Your dentist uses techniques to minimize pain and discomfort and can ask you how you are feeling, so you accept the procedures and do your best to keep still. Your pet does not understand the benefit of dental procedures, and he or she reacts by moving, trying to escape, or even biting.<br /><br />
              Anesthesia makes it possible to perform the dental procedures with less stress and pain for your pet. In addition, anesthesia allows for a better cleaning because your pet is not moving around and risking injury from the dental equipment. If radiographs (x-rays) are needed, your pet needs to be very still in order to get good images, and this is unlikely without heavy sedation or anesthesia.<br /><br />
        ...
        <div className="relative flex justify-center w-full bg-cover bg-[url('/PGbg.png')] bg-no-repeat my-44 py-56 px-4">
          <p className="text-center font-[Poppins] font-normal text-[20px] sm:text-[33px] w-full max-w-[1158px]">
            <span className="font-bold">Do you have questions about your pet's Dental Care</span><br />
